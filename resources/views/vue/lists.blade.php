...
@section('content')
    <div id="app">
        <section v-show="inProgressAssignments.length">
            ...
            <ul>
                <li v-for="assignment in inProgressAssignments" v-bind:key="assignment.id">
        ...
        <section v-if="completedAssignments.length" class="mt-3">
            ...
            <ul>
                <li v-for="assignment in completedAssignments">
                    <label>${assignment.name} <input type="checkbox" v-model="assignment.complete" v-bind:key="assignment.id"></label>
                </li>
            </ul>
        </section>
    </div>
